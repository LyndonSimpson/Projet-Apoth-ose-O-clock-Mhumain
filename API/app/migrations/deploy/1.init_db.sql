...
CREATE TABLE IF NOT EXISTS "has_favorites" ( --TODO voir si on doit faire une deuxième table d'associations pour dog_has_favorites ?
...
/* au cas où on doit bien utiliser un table has fav pour les chats et une pour les humains
*
