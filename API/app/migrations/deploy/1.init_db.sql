...
CREATE TABLE IF NOT EXISTS "cat" (
  ...
  "siblings_id" integer NOT NULL REFERENCES "cat"("id"),
  "owner_id" integer NOT NULL REFERENCES "human"("id"),
  "account_id" integer NOT NULL REFERENCES "account"("id"),
  "created_at" timestamptz NOT NULL DEFAULT CURRENT_TIMESTAMP,
  "updated_at" timestamptz
);

CREATE TABLE IF NOT EXISTS "cat_has_favorites" ( --TODO voir si on doit faire une deuxième table d'associations pour dog_has_favorites ?
