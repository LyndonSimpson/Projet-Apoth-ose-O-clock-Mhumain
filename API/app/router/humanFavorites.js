...
/*--------------------------------- favorites router (create, read, update not needed, delete) : */
    ...
    */
    router.post("/humanfavorites", humanFavoritesController.newFavorite);
    ...
    */
    router.get("/humanfavorites/:id", humanFavoritesController.allFavorites);
    ...
    */
    router.delete("/humanfavorites/:id", humanFavoritesController.delete);
