...
//todo = pour les tests, à supprimer après
    ...
    * @param {number} id.path.required - category identifier
    */
     router.patch("/humanupdate", authorizationMiddleware, upload.single("fileUpload"), humanController.updateImage);
    ...
    */
    ...
    router.post("/humanmessages", authorizationMiddleware, sendMailController.sendMessage);
